...
pairs(synthetic_data[, c("X1", "X2", "X3", "X4", "X5")],
...
aggr(data.MCAR.multi, numbers=TRUE, labels=names(synthetic_data_complex_poly), prop = c(TRUE, FALSE))
```
...
plot(synthetic_data$X1,synthetic$X2, col = 'red')
