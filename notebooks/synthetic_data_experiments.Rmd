...
```{r, echo = F}
# List of precomputed imputed datasets (used for retrieving the metrics)
imputed_datasets <- list(
  "Mean" = mean_imputation_data,
  "Median" = median_imputation_data,
  "Regression" = regression_imputation_data,
  "Hot-deck" = hotdeck_imputation_data,
  "EM" = em_imputation_data,
  "GAM" = gam_imputation_data,
  "Tree" = forest_imputation_data
)

# Use the created function to generate the plot
create_distribution_metrics_plot(train_data, imputed_datasets)
```
