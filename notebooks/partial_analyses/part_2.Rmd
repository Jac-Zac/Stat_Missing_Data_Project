...
variables <- list(
  list(var = "displacement", label = "displacement", title = "Scatterplot displacement-mpg", color = nord_colors[1]),
  list(var = "horsepower", label = "horsepower", title = "Scatterplot horsepower-mpg", color = nord_colors[2]),
  list(var = "weight", label = "weight", title = "Scatterplot weight-mpg", color = nord_colors[3]),
  list(var = "acceleration", label = "acceleration", title = "Scatterplot acceleration-mpg", color = nord_colors[4])
)
...
variables <- list(
  list(var = "displacement", label = "displacement", title = "displacement histogram", color = nord_colors[1]),
  list(var = "horsepower", label = "horsepower", title = "horsepower histogram", color = nord_colors[2]),
  list(var = "weight", label = "weight", title = "weight histogram", color = nord_colors[3]),
  list(var = "acceleration", label = "acceleration", title = "acceleration histogram", color = nord_colors[4])
)
...
```{r, echo=FALSE}
create_histogram(auto_mpg, "mpg", "Mpg", "mpg histogram", nord_colors[6])
```
...
```{r plot mv, warning=FALSE, fig.height=9}
...
```{r}
complex_ds_mean<-impute_mean(no_categorical_dataset)
complex_ds_del<-listwise_deletion(no_categorical_dataset)
...
models <- list(
  ...
  "Linear regression" = final_predictions_reg,
...
final_methods <- c("Linear regression", "GAM Imputation", "Random Forest")
