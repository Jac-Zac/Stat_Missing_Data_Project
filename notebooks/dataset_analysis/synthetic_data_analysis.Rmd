...
We start the analyses by creating a synthetic with linear correlation between the variables. And a variable to predict that is also linearly correlated to the covariates.
